...
star-submit-template -template submitByRun_perFile.xml -entities listOfFiles=/star/u/lazhang/data01/CF/urqmd/K0CF_urqmd/analysis/3p2Urqmd.list,cutFile=/star/u/lazhang/data01/CF/urqmd/analysis_v3.0/cutDefault.txt
